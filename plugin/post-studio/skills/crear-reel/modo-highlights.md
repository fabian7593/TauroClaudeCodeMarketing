...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/crear-reel/scripts/join_xfade.sh" 0.35 "video_sin_audio.mp4" "clip01_video.mp4" "clip02_video.mp4" "clip03_video.mp4"
```
...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/crear-reel/scripts/check_audio.sh" "audio_final.m4a"
```
